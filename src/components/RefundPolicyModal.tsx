      ...
      <div className="relative w-full max-w-2xl bg-[#0A0F29] border border-[#1A2342] rounded-2xl shadow-2xl overflow-hidden my-8">
        <div className="p-5 border-b border-[#1A2342] flex items-center justify-between bg-[#030617]">
          <div className="flex items-center gap-2.5">
            ...
            <h3 id="refund-modal-title" className="font-display font-bold text-lg sm:text-xl text-[#F8FAFC]">
        ...
        <div className="p-6 space-y-4 text-[15px] sm:text-[16px] text-[#CBD5E1] leading-relaxed">
          <p>
          ...
          <div className="p-4 rounded-xl bg-[#030617] border border-[#1A2342] space-y-2">
            <h4 className="font-bold text-[#F8FAFC] flex items-center gap-2">
          ...
          <div className="pt-4 border-t border-[#1A2342] flex justify-end">
